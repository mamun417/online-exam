<div class="col-lg-7">
    <div class="form-group">
        <label control-label">Name<span class="required-star"> *</span></label> 
...
<div class="col-lg-7">
    <div class="form-group">
        <label control-label">Department<span class="required-star"> *</span></label>
...
<div class="col-lg-7">
    <div class="form-group">
        <label control-label">Subject<span class="required-star"> *</span></label>
...
<div class="col-lg-7">
    <div class="form-group">
        <label control-label">Student Type<span class="required-star"> *</span></label>
...
<div class="col-lg-7">
    <div class="form-group">
        <label control-label">Total Questions<span class="required-star"> *</span></label>
...
<div class="col-lg-7">
    <div class="form-group">
        <label control-label">Total Marks<span class="required-star"> *</span></label>
...
<div class="col-lg-7">
    <div class="form-group">
        <label control-label">Negative Marks/Question<span class="required-star"> *</span></label>
