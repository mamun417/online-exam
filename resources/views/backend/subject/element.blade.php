<div class="form-group">
    <label class="col-lg-2 control-label">Subject Name<span class="required-star"> *</span></label>
    <div class="col-lg-6">
...
<div class="form-group">
    <label class="col-lg-2 control-label">Subject Code<span class="required-star"> *</span></label>
    <div class="col-lg-6">
